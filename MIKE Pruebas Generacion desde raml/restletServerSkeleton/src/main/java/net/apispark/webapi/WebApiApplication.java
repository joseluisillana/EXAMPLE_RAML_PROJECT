...
import net.apispark.webapi.resource.server.LogStructuredServerResource;
import net.apispark.webapi.resource.server.LogUnstructuredServerResource;
...
public class WebApiApplication extends Application {
     ...
     */
    public static final String ROUTE_LOGSTRUCTURED = "/log/structured";

    public static final String ROUTE_LOGUNSTRUCTURED = "/log/unstructured";
    ...
    public Router createApiRouter() {
        ...
        apiRouter.attach(ROUTE_LOGSTRUCTURED, LogStructuredServerResource.class);
        apiRouter.attach(ROUTE_LOGUNSTRUCTURED, LogUnstructuredServerResource.class);
